...
const formatCurrenty = amount => formatter.format(amount);
...
const calcNetIncome = (amount, printDetail) => {
    ...
    if(printDetail) {
        console.log("AFP: " + formatCurrenty(afp));
        console.log("SFS: " + formatCurrenty(sfs));
        console.log("TSS: " + formatCurrenty(tss));
        console.log("ISR: " + formatCurrenty(isr));
        console.log("Descuento total: " + formatCurrenty(totalDiscount));
        console.log("Salario neto: " + formatCurrenty(netIncome));
        console.log("Salario neto quincenal: " + formatCurrenty(netIncome/2));
    }
    return {
      afp,
      sfs,
